        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-8">
            ...
            <div className="hidden lg:block lg:col-span-8 lg:row-start-2 -mt-8 space-y-8">
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm border border-mosque/5">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  <div className="flex flex-col items-center justify-center p-4 bg-mosque/5 rounded-lg border border-mosque/10">
                    ...
                    <span className="text-xs uppercase tracking-wider text-nordic/50">Square Area</span>
                  </div>
                  <div className="flex flex-col items-center justify-center p-4 bg-mosque/5 rounded-lg border border-mosque/10">
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm border border-mosque/5">
                ...
                <div className="prose prose-slate max-w-none text-nordic/70 leading-relaxed">
                  <p className="mb-4">
                    {property.description || `Experience modern luxury in this architecturally stunning home located in ${property.location}. Designed with an emphasis on indoor-outdoor living, the residence features floor-to-ceiling glass walls that flood the interiors with natural light.`}
                  </p>
                </div>
              </div>
          ...
          <div className="block lg:hidden space-y-8">
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm border border-mosque/5">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="flex flex-col items-center justify-center p-4 bg-mosque/5 rounded-lg border border-mosque/10">
                    <span className="material-icons text-mosque text-2xl mb-2">square_foot</span>
                    <span className="text-xl font-bold text-nordic">{property.area}</span>
                    <span className="text-xs uppercase tracking-wider text-nordic/50">Area</span>
                  </div>
                  <div className="flex flex-col items-center justify-center p-4 bg-mosque/5 rounded-lg border border-mosque/10">
                    <span className="material-icons text-mosque text-2xl mb-2">bed</span>
                    <span className="text-xl font-bold text-nordic">{property.beds}</span>
                    <span className="text-xs uppercase tracking-wider text-nordic/50">Beds</span>
                  </div>
                  <div className="flex flex-col items-center justify-center p-4 bg-mosque/5 rounded-lg border border-mosque/10">
                    <span className="material-icons text-mosque text-2xl mb-2">shower</span>
                    <span className="text-xl font-bold text-nordic">{property.baths}</span>
                    <span className="text-xs uppercase tracking-wider text-nordic/50">Baths</span>
                  </div>
                  <div className="flex flex-col items-center justify-center p-4 bg-mosque/5 rounded-lg border border-mosque/10">
                    <span className="material-icons text-mosque text-2xl mb-2">directions_car</span>
                    <span className="text-xl font-bold text-nordic">2</span>
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm border border-mosque/5">
                ...
                <div className="prose prose-slate max-w-none text-nordic/70 leading-relaxed">
                  <p className="mb-4">
                    {property.description || `Experience modern luxury in this architecturally stunning home located in ${property.location}.`}
                  </p>
                </div>
              </div>
